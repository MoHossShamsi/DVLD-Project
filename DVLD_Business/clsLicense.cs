...
namespace DVLD_Business
{
    public class clsLicense
    {
        ...
        public bool ReleaseDetainedLicense(int ReleasedByUserID, ref int ApplicationID)
        {
            ...
            Application.PaidFees = clsApplicationsTypes.Find((int)clsApplications.enApplicationType.ReleaseDetainedDrivingLicsense).Fees;
        ...
        public clsLicense RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplications.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationsTypes.Find((int)clsApplications.enApplicationType.RenewDrivingLicense).Fees;
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplications.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationsTypes.Find(Application.ApplicationTypeID).Fees;
            Application.CreatedByUserID = CreatedByUserID;
