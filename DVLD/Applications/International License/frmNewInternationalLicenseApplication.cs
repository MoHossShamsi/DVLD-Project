...
namespace DVLD.Applications.International_License
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void frmNewInternationalLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblFees.Text = clsApplicationsTypes.Find((int)clsApplications.enApplicationType.NewInternationalLicense).Fees.ToString();
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
           ...
           clsInternationalLicense InternationalLicense= new clsInternationalLicense();
            ...
            InternationalLicense.PaidFees = clsApplicationsTypes.Find((int)clsApplications.enApplicationType.NewInternationalLicense).Fees;
