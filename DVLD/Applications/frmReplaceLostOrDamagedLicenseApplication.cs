...
namespace DVLD.Applications.ReplaceLostOrDamagedLicense
{
    public partial class frmReplaceLostOrDamagedLicenseApplication : Form
    {
        ...
        private void rbDamagedLicense_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = clsApplicationsTypes.Find(_GetApplicationTypeID()).Fees.ToString();
        }
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            {
                MessageBox.Show("Selected License is not Inactive, choose an active license."
