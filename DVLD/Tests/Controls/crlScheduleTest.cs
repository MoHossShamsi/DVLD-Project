    ...
    public partial class ctrlScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID,int AppointmentID=-1 )
        {
           ...
           //decide if the createion mode is retake test or not based if the person attended this test before
            ...
            {
                lblRetakeAppFees.Text = clsApplicationsTypes.Find((int)clsApplications.enApplicationType.RetakeTest).Fees.ToString();
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.PaidFees = clsApplicationsTypes.Find((int)clsApplications.enApplicationType.RetakeTest).Fees;
